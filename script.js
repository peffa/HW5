...
//   pulls saved calendar tasks from local storage
...
//   displays current day of week, month, and numeric day of month in third line of heading
  $('#currentDay').text(moment().format('dddd') + ", " + moment().format('MMMM Do'));
  
//   displays colors of hour rows based on current time of day
  var counter = 1;
